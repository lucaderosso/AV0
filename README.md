...
<br>
# Grids and Layers
Visuals are arranged based on a simple grid system of rows and columns, as one would do in approaching a graphic design.<br>The viewport where visuals are displayed is divided in a number of columns and rows. Each cell generated by this subdivision can allocate one visual element. 

![Grids](https://github.com/lucaderosso/AV0/blob/master/images/grid_v0_00.png)

The cell defines  where the element will be positioned, its maximum size and the roaming areas at its disposal.

![Cells](https://github.com/lucaderosso/AV0/blob/master/images/grid_v0_01.png)
